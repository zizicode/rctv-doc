...
export const postModel = {
  async create(data) {
    const { title, slug, body, cover_url, author_id, published = false, description, keywords=[] } = data
    const result = await pool.query(
      `INSERT INTO posts (title, slug, body, cover_url, author_id, published, description, keywords) 
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8) 
       RETURNING *`,
      [title, slug, body, cover_url, author_id, published, description, keywords],
    )
  ...
  async update(id, data) {
    ...
    const allowedFields = ["title", "slug", "body", "cover_url", "published", "description", "keywords"]
